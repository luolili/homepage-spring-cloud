...
import com.homepage.util.AlipayConfig;
import com.homepage.util.LeeJSONResult;
...
public class AlipayController {
    ...
    public ModelAndView createOrde2r(Order order) throws Exception {
    ...
    @ResponseBody
    public LeeJSONResult createOrder(Order order) throws Exception {
